...
/* handles all hd-interrupts, and read/write requests to
...
void 
rw_hd(int rw, struct buffer_head * bh)
{
 ...
 */
static void 
add_request(struct hd_request * req)
{
...
void 
rw_abs_hd(int rw,unsigned int nr,unsigned int sec,unsigned int head,
	unsigned int cyl,struct buffer_head * bh)
{
