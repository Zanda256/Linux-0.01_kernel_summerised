...
Image: boot/boot tools/system tools/build
	...
	tools/build boot/boot tools/system.bin > Gia
#	sync
...
run:
	qemu-system-i386 -drive format=raw,file=Gia,index=0,if=floppy -boot a -hdb root_fs.img -m 8 -machine pc-0.10
	
dump:
	objdump -D --disassembler-options=intel tools/system > System.dum

clean:
	rm -f Gia System.map tmp_make boot/boot core
...
init/main.o : init/main.c include/unistd.h include/sys/stat.h \
  ...
  include/utime.h include/time.h include/gia/tty.h include/termios.h \
  include/gia/sched.h include/gia/head.h include/gia/fs.h \
  include/gia/mm.h include/asm/system.h include/asm/io.h include/stddef.h \
